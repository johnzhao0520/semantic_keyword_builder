...
# ---------------------------------------------------------
# Internal use only: Set your default API key here to avoid entering it manually.
# WARNING: Do not share this file if it contains your real API key.
DEFAULT_API_KEY = "AIzaSyCKsrzbSfoCh4EJIsjyicQURUCFpiPwPcg"  # e.g. "AIzaSy..."
...
api_key = st.sidebar.text_input(
    ...
    type="password",
    help="API key for your language model provider."
)
